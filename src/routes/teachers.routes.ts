...
import { createTeacherController, deleteTeacherController, listTeacherByIDController, listTeacherController, updateTeacherController } from "../controllers/teachers/teachers.controller";
...
const teacherRoutes = () => {
  router.post("", validateSchemaMiddleware(teacherSchema), authenticationMiddleware, createTeacherController);
