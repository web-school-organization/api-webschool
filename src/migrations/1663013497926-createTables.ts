...
export class createTables1663013497926 implements MigrationInterface {
    name = 'createTables1663013497926'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "teachers_teams_teams" ADD CONSTRAINT "FK_7fde41bc5a9592f5b759f46c34d" FOREIGN KEY ("teamsId") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
