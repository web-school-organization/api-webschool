...
export class createTables1662479941129 implements MigrationInterface {
  name = "createTables1662479941129";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "teams" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "schoolId" uuid, CONSTRAINT "PK_7e5523774a38b08a6236d322403" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "teams_teachers_teachers" ("teamsId" uuid NOT NULL, "teachersId" uuid NOT NULL, CONSTRAINT "PK_fcedd9786f24a6eba472c9cceab" PRIMARY KEY ("teamsId", "teachersId"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0afc0cc7552d00a1c11871f93c" ON "teams_teachers_teachers" ("teamsId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ff2cd597829bdb2868095f61b5" ON "teams_teachers_teachers" ("teachersId") `
    );
    await queryRunner.query(
      `ALTER TABLE "feedbacks" ADD CONSTRAINT "FK_165a973a9ecf1c3eb34a2524c48" FOREIGN KEY ("teacherId") REFERENCES "teachers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "feedbacks" ADD CONSTRAINT "FK_68fabd60b33f830d0f0c4d2bf25" FOREIGN KEY ("studentId") REFERENCES "students"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "students" ADD CONSTRAINT "FK_1772a9f1f75e1172c19b0390e71" FOREIGN KEY ("teamId") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "teams" ADD CONSTRAINT "FK_1ba3c771ceea80af631b284a47b" FOREIGN KEY ("schoolId") REFERENCES "schools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "schools" ADD CONSTRAINT "FK_55332608bccd7ac09cdab118556" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "teams_teachers_teachers" ADD CONSTRAINT "FK_0afc0cc7552d00a1c11871f93c1" FOREIGN KEY ("teamsId") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "teams_teachers_teachers" ADD CONSTRAINT "FK_ff2cd597829bdb2868095f61b51" FOREIGN KEY ("teachersId") REFERENCES "teachers"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "teams_teachers_teachers" DROP CONSTRAINT "FK_ff2cd597829bdb2868095f61b51"`
    );
    await queryRunner.query(
      `ALTER TABLE "teams_teachers_teachers" DROP CONSTRAINT "FK_0afc0cc7552d00a1c11871f93c1"`
    );
    await queryRunner.query(
      `ALTER TABLE "schools" DROP CONSTRAINT "FK_55332608bccd7ac09cdab118556"`
    );
    await queryRunner.query(`ALTER TABLE "teams" DROP CONSTRAINT "FK_1ba3c771ceea80af631b284a47b"`);
    await queryRunner.query(
      `ALTER TABLE "students" DROP CONSTRAINT "FK_1772a9f1f75e1172c19b0390e71"`
    );
    await queryRunner.query(
      `ALTER TABLE "feedbacks" DROP CONSTRAINT "FK_68fabd60b33f830d0f0c4d2bf25"`
    );
    await queryRunner.query(
      `ALTER TABLE "feedbacks" DROP CONSTRAINT "FK_165a973a9ecf1c3eb34a2524c48"`
    );
